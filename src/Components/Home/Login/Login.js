    ...
    <HomeContainer>
      ...
      {showSignUp ? (
        <SignUpBox>
          ...
          <div style={{ textAlign: "center" }}>
            <FormItem style={{ marginRight: "100px" }}>
              <button className="login_bt" onClick={regUser}>
                <h3>Register</h3>
              </button>
            </FormItem>

            <FormItem>
              <button className="spl_link" onClick={handleBox}>
                {" "}
        ...
        <LoginBox className="Flexv2">
          ...
          <FormItem>
            <button className="login_bt" onClick={handleLogin}>
              <h3>Login</h3>
            </button>
          </FormItem>
          <FormItem>
